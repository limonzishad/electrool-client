            ...
            <div className="drawer drawer-end">
                ...
                <div className="drawer-content flex flex-col">
                    <div className="w-full navbar bg-base-100 px-10">
                        <div className="flex-1 px-1 mx-1 text-xl font-bold">ELECTROOL</div>
                                ...
                                <li><NavLink to='/' className='rounded-md font-medium'>HOME</NavLink></li>
                                {
                                    user ?
                                        <>
                                            ...
                                            <li>
                                                <NavLink to='/products' className='rounded-md font-medium'>PRODUCTS</NavLink>
                                            </li>
                                            <li>
                ...
                <div className="drawer-side">
                    ...
                    <ul className="h-screen menu p-3 overflow-y-auto w-50 bg-base-100 fixed top-0">
                        <li><NavLink to='/' className='rounded-md font-medium'>HOME</NavLink></li>
                        {
                            user ?
                                <>
